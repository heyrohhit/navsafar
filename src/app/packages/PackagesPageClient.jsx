// src/app/packages/PackagesPageClient.jsx
// ─────────────────────────────────────────────────────────────────────────────
// Client Component — all interactive logic lives here
// ─────────────────────────────────────────────────────────────────────────────
"use client";

// ✅ FIX 3: All missing imports added
...
function openWhatsApp(pkg) {
  ...
  window.open(
    `https://wa.me/918882128640?text=${encodeURIComponent(msg)}`,
    "_blank"
  );
}
    ...
    >
      ...
      <div className="relative h-44 overflow-hidden">
        ...
        {(pkg.popular === true || pkg.popular === "true") && (
          <span className="absolute top-3 left-3 bg-amber-400 text-black text-[10px] font-black px-2 py-1 rounded-full">
            ⭐ Popular
          </span>
        )}
        {pkg.rating && (
...
// ✅ FIX 5: Single default export — PackagesInner wrapped in Suspense (required for useSearchParams)
