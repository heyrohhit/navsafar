...
export const metadata: Metadata = {
  ...
  description: "Explore 100+ domestic and international tour packages. Best price guarantee. Includes flights, hotels, visa. Book now!",
  keywords: [
    "tour packages india",
  ...
  openGraph: {
    title: "Tour Packages - Domestic & International | NavSafar",
    description: "Explore 100+ domestic and international tour packages with best prices",
    images: [
      {
        url: "/assets/bg.jpg",
        width: 1200,
