...
export const metadata = {
  ...
  description:
    "Read expert travel tips, destination guides, trip planning advice, itineraries and travel stories from NavSafar.",
  keywords: [
    "travel blog india",
    "travel tips",
    "destination guides",
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${SITE_URL}/assets/bg.jpg`,
        width: 1200,
        height: 630,
        alt: "NavSafar Travel Blog",
      },
    ],
  },
  twitter: {
    ...
    <div className="min-h-screen bg-[#060e10] text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        {blogs.length === 0 ? (
          ...
          <>
            <FeaturedCard blog={featuredBlogs[0]} />
