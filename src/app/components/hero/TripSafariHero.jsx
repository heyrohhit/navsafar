  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <AnimatePresence mode="sync">
          <motion.div
            ...
            className="relative w-full h-[120vh] -z-10" // Extra height for parallax
          >
            <Image
              src={slide.image}
              alt="Hero background"
      ...
      <div
        ...
        style={{
          background: `radial-gradient(ellipse 70% 60% at 30% 40%, ${slide.color}, transparent)`,
          opacity: 0.07,
        }}
      />
      ...
      {/* Main Content */}
      <div
        className="relative z-40 w-full mx-auto flex flex-col justify-between gap-6"
        style={{ maxWidth: "1280px", padding: "clamp(24px,5vw,80px) clamp(16px,4vw,48px)" }}
      >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <span
                  ...
                  style={{
                    background: `linear-gradient(90deg, transparent, ${slide.color})`,
            ...
            <div className="overflow-hidden">
              <AnimatePresence mode="wait">
                <motion.h1
                  ...
                  className="block font-black tracking-tight leading-none text-white p-3"
        ...
        <div className="flex gap-2 justify-center pb-2">
          {slides.map((s, i) => (
            <button
              key={i}
              onClick={() => setIndex(i)}
              className={`h-1 rounded-full cursor-pointer border-0 p-0 transition-all duration-300 ${
                i === index ? "w-7" : "w-3"
              }`}
              style={{
