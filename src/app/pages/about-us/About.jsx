...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className={`relative overflow-hidden bg-gradient-to-br from-blue-600 to-[#04b586] text-white py-20 transition-all duration-1000 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-2xl md:text-6xl font-bold mb-6">
              About <br/><span className="text-4xl shadow-2xl">Navsafar</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className={`text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-[#02a8f9] to-[#0298f6] bg-clip-text text-transparent`}>
                  {stat.number}
                </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-blue-600 to-[#04b586] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a 
                href="/contact"
                className="px-8 py-4 bg-[#04b586] text-white-900 shadow-2xl font-semibold rounded-xl hover:bg-[#0471b5] transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                Contact Us
              </a>
            </div>
