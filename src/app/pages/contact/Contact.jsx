...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: "📍",
      label: "Visit Us",
      value: "WZ-447 First Floor, Left Side Nagal Raya, Delhi - 110046",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-8">
            {contactInfo.map((info, index) => (
              <div 
                key={index}
                className={`group flex relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 cursor-pointer ${
                  isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                }`}
                style={{ transitionDelay: `${400 + index * 100}ms` }}
              >
                <div className={`max-[780px]:w-1/2 w-1/5 bg-gradient-to-br ${info.color} flex items-center justify-center relative overflow-hidden`}>
                  <div className="absolute inset-0">
