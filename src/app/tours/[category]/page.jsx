...
export default function CategoryTours() {
  ...
  const category = params.category ? decodeURIComponent(params.category).replace(/-/g, ' ') : '';
  ...
  useEffect(() => {
    let tours = portfolioItems.filter(tour => 
  ...
  }, [category, debouncedSearchTerm, sortBy]);

  const getCategoryImage = () => {
    const categoryImages = {
      "International Luxury Tours": "https://images.unsplash.com/photo-1763571589025-efacfe091161?q=80&w=1080",
      "Honeymoon Packages": "https://images.unsplash.com/photo-1614505241347-7f4765c1035e?q=80&w=1080",
      "Religious Tours": "https://images.unsplash.com/photo-1649147313351-c86537fda0eb?q=80&w=1080",
      "Adventure Tours": "https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=1080",
      "Customized Journeys": "https://images.unsplash.com/photo-1759773936612-164cc2e19671?q=80&w=1080"
    };
    return categoryImages[category] || "https://images.unsplash.com/photo-1469474968028-56623f02e42e?q=80&w=1080";
  };
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center">
              ...
              {isClient ? (
                ...
                >
                  Discover our curated collection of {category.toLowerCase()} with exclusive experiences
                </motion.p>
              ) : (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <button
              ...
              className="flex items-center gap-2 text-[#C9A24D] hover:text-[#B8934D] transition-colors"
            >
              <ArrowLeft size={20} />
              Back to All Tours
            </button>
